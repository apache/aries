...
public class StrSubstitutor {
     ...
     * @return true if altered
     */
    protected boolean substitute(final StringBuilder buf, final int offset, final int length) {
     ...
     */
    protected String resolveVariable(final String variableName, final StringBuilder buf, final int startPos, final int endPos) {
