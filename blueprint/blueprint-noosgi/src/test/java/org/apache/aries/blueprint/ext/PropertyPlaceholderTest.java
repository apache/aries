...
//    }
    ...
    private LateBindingValueMetadata makeProperty(final String prop) {
        ...
        substitutor.setVariablePrefix(AbstractPropertyPlaceholder.DEFAULT_PLACEHOLDER_PREFIX);
        substitutor.setVariableSuffix(AbstractPropertyPlaceholder.DEFAULT_PLACEHOLDER_SUFFIX);
        ...
        return new LateBindingValueMetadata(
            substitutor,
            new ValueMetadata() {
