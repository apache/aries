...
public class BinaryCompatibilityTest
{
  ...
  public void test_jdk_chap13_4_4_2()
  {
    ...
    assertFalse(
        "If a change to the direct superclass or the set of direct superinterfaces results in any class or interface no longer being a superclass or superinterface, respectively, it will break binary compatibility.",
        bcs.isCompatible());
   assertEquals("The superclasses or superinterfaces have stopped being super: [versioning/java/files/TestC, versioning/java/files/TestA]", bcs.getReason()); 
  }
  ...
  public void test_jdk_chap13_4_5_1() {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));    
    assertEquals("The method int convert(java/lang/Object) has been deleted or its return type or parameter list has changed.", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_4_7_2()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The new field bar conflicts with the same field in its super class. For more details, check the Binary Compatibility section(Chapter 13) of the Java Specification.", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_4_8_1()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The public or protected field aa was not final but has been changed to be final.", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_4_9_1()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The public or protected field aa was static but is changed to be non static or vice versa.", bcs.getReason());
    assertFalse(
        "If a field was static is changed to be non-static, then it will break compatibility.",
        bcs.isCompatible());
  }
  ...
  public void test_jdk_chap13_4_11_1()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The method int getFooLen(java/lang/STring) has been deleted or its return type or parameter list has changed.", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_4_12_1()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The method int getCooLen(java/lang/String) has been deleted or its return type or parameter list has changed.", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_4_14_1()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The method int getCooLen(java/lang/String) has changed from non abstract to abstract. ", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_4_15_1()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The method int getCooLen(java/lang/String) was not final but has been changed to be final.", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_4_17_1()
  {
    ...
    oldCR.accept(oldCV, 0);
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The method int getCooLen(java/lang/String) has changed from static to non-static or vice versa.", bcs.getReason());
    assertFalse(
  ...
  public void test_jdk_chap13_5_2_1()
  {
    ...
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The superclasses or superinterfaces have stopped being super: [versioning/java/files/TestB]", bcs.getReason());
    assertFalse(
        "Changes to the interface hierarchy resulting an interface not being a super interface should break compatibility.",
        bcs.isCompatible());
  }
  ...
  public void test_jdk_chap13_5_3_1()
  {
    ...
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The method int getFoo() has been deleted or its return type or parameter list has changed.", bcs.getReason());
    assertFalse(
        "Deleting a method in an interface should break compatibility.",
        bcs.isCompatible());
  }
  ...
  public void test_jdk_chap13_5_5_2()
  {
    ...
    BinaryCompatibilityStatus bcs = newCV.getClassDeclaration().getBinaryCompatibleStatus((oldCV.getClassDeclaration()));
    assertEquals("The method int getFoo(int) has been deleted or its return type or parameter list has changed.", bcs.getReason());
    assertFalse(
        "Changing a method parameter in an interface should  break compatibility.",
        bcs.isCompatible());
  }
