...
dojo.provide("goat.elements.RelationshipAggregation");
...
dojo.declare("goat.elements.RelationshipAggregation", goat.elements.ElementBase, {
		...
		constructor : function(component, /*String*/ type, /*goat.RelationshipAggregator*/ content) {
	        //console.log("Building RelationshipAggregation element");
		...
		buildTwistie: function(){
			...
			function getItemsCallBack(){
				...
				for( var relationshipKey in _this.content.relationships ){
					var /*goat.RelationshipElement*/ relationship = _this.content.relationships[relationshipKey];
